...
public class SetMapMiddleCommand implements CommandExecutor {
    private final DiscountSurvivalGames plugin;

    public SetMapMiddleCommand(DiscountSurvivalGames plugin) { this.plugin = plugin; }
    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args) {
        ...
        try {
            ...
            worldFile.setMapMiddle(playerLocation);
